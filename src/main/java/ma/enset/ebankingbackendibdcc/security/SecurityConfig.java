package ma.enset.ebankingbackendibdcc.security;
...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, CustomerRepository customerRepository) throws Exception {
    return  httpSecurity
